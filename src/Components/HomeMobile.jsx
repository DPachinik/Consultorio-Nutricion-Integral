...
const HomeMobile = () => {
  return (
    <div className="container mx-auto flex h-full flex-col items-center justify-evenly px-2 md:hidden">
      <div className="w-full place-items-center gap-4 pt-6 leading-[1.5]">
      ...
      <div className="relative flex h-[200px] min-h-[150px] w-[200px] min-w-[150px] flex-col rounded-full bg-alimentos bg-cover bg-center shadow-[0_0_20px_rgba(0,0,0,0.6)] ring-1 ring-gray-400 hover:shadow-lima">
