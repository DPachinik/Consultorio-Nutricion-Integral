...
const BotonConsulta = () => {
  return (
    <a
      ...
      className="mx-auto flex w-[200px] items-center justify-center gap-2 rounded-md bg-gradient-to-br from-rose-900 via-rose-800 to-rose-700 py-2 text-white shadow-md shadow-primario"
